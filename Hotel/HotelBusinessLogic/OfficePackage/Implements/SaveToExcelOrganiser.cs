...
{
    public class SaveToExcelOrganiser : AbstractSaveToExcelOrganiser
    {
        ...
        protected override void CreateExcel(ExcelInfoOrganiser info)
        {
        ...
        protected override void SaveExcel(ExcelInfoOrganiser info)
        {
